...
\vskip.3in
``Parameterization 2'': goal was to make welfare higher under mediator
\begin{itemize}
							...
							\begin{itemize}
								\item When $e=1$: $\frac{1}{1-d_h}\left\{pT(1+g^*) + (1-p)(W-D(1+g^*))\right\} - \frac{p(1-d_l)(D+T)}{(1-d_l)(1-pT)+(1-p)D}$
									\begin{itemize}
										...
										\item \color{orange} Parameterization 2: $g1$ is negative, creates negative upper bound for $d_h$. Separating with concessions equilibrium can't be sustained.
									\end{itemize}
