...
\color{blue} I think it's possible that this condition can never be satisfied (i.e. if e=1 is IC, you'd never want to call in the mediator). But I haven't tried to prove it yet
