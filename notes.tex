...
\textbf{NOW, it's time to explore this equation and see if it's even possible to pick a gift high enough and an $e$ low enough to satisfy the low type's incentive constraint}
\begin{itemize}
	\item Digitize handwritten notes pages 1-3
\end{itemize}
