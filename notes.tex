...
\begin{itemize}
	...
	\item Someone who \textit{can't} cooperate under either $e=0$ or $e=1$ CAN cooperate under mediator
		\begin{itemize}
			...
			\item I still have a question about the overall game: if $e=0$ provides higher welfare if it were enforceable but it's not, do we just go with $e=1$?
	...
	\item From Eli four years ago: why can mediator do what the two sides cannot?
		\begin{itemize}
			\item How does this differ from binding arbitration?
		\end{itemize}
	\item Be clear about assumptions on cost of gifts; make statement in third paragraph of model section match
\end{itemize}
\end{document}