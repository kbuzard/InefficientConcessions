	...
	\color{ForestGreen} 
			\begin{itemize}
					...
					\item Minimum $\de$ for $e=0$ CSE / no material value case to be sustainable. Remember that $g^0 = p(T+D)$
						...
						\]
						I have a page of math that shows that this is strictly smaller than $d^h$. This means that the set of types who can make and sustain peace under the CSE with no material value / CSE with material value and $e=0$ is larger than the set of types who can make and sustain peace under the repeated game.
							\begin{itemize}
