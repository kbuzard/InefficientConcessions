	...
	\color{ForestGreen} 
			\begin{itemize}
				\item Obviously we can come up with other parameterizations in which this may look a little more reasonable
					\begin{itemize}
						\item Go through welfare expressions carefully to understand where the welfare improvement is coming from
						\item Can I derive an analytical expression for when the mediator enhances welfare?
							\begin{itemize}
