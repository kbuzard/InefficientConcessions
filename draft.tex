...
The range of efficiency that allows a mediator to make mechanism $M$ incentive compatible and individually rational for both types is given in Theorem~\ref{theorem:med}.
