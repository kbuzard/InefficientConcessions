...
In the separating equilibrium constructed here, players will believe that any concession not equal to the equilibrium concession of the high type $g_h$ is a low type gift.  In this case, the binding incentive compatibility constraint is the low type IC constraint, which when simplified to allow $g_l=0$  is:\\  
\begin{equation*}
...
\begin{equation*}
p\left(\frac{T}{1- \delta_h}\right)+(1-p)\left(\frac{W-D}{1- \delta_h}\right) - g_h \geq p\left(\frac{T}{1- \delta_h}\right) +(1-p)\left({-D}+\frac{\delta_h(W-D)}{1- \delta_h} \right)
\end{equation*}
...
\be
 \frac{W}{W+T+D}\geq p
\ee
i.e. The high types prefer the \emph{concessions separating equilibrium} when $p$ is smaller than $\frac{W}{W+T+D}$. \hfill $\blacksquare$\\
\\
{\bf \emph{Mediation}}\\
