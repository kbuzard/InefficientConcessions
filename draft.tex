...
\begin{lemma}
	Assuming that a separating equilibrium exists when concessions have material value and are efficient (where $e=1$), it is optimal to give efficient gifts in a separating equilibrium.
...
\begin{theorem}
	Under some parameters, the optimal equilibrium uses inefficient concessions.
	\label{theorem:4}
\end{theorem}
...
\begin{theorem}
	A mediator can be used to eliminate inefficient concessions.
	\label{theorem:5}
\end{theorem}
