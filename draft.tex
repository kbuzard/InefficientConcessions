...
In period 0, countries 1 and 2 simultaneously give costly concessions $g_1$ and $g_2$ $\in \mathbb{R} \geq 0$. Concessions are given at cost $C(g_i)$ and benefit the recipient $g_i$, where $i\in\left\{l,h\right\}$. For simplicity, we initially assume $C(g_i)= g_i$. We will relax this assumption later.
