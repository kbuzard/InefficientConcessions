...
\pause
Now assume a low type will use concessions against you, i.e. to increase their payoffs from fighting \hyperlink{Supplemental}{\beamerbutton{Modified Payoffs}}
\vskip.1in
\pause
...
\end{beamerboxesrounded}
\[
  U_h=(1-\de_h)(-g) + \de_h \left[pT(1+eg)+peg+(1-p)(W-D(1+eg))\right]
\]
\pause
...
\begin{itemize}[<+->]
  \item Mechanism: if two high types, give concession and play `Trust'; Otherwise, no concession and `Fight'
	\item Concession is necessary to get truthful revelation
